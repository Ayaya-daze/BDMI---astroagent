...
try:
    ...
    # Try local .env first, then home directory
    # You may refer to the .env.example file for the expected environment variables
    env_path = Path('.env')
    if env_path.exists():
        ...
        try:
            ...
            # Path.home() can fail in some cloud environments
            pass
except ImportError:
    pass
except Exception:
    # Silently handle any other dotenv errors
    pass
...
class EgentConfig:
    ...
    # API base URL (optional, for custom OpenAI endpoints)
